...
```
    npm i discord.js @discordjs/builders @discordjs/rest @discordjs/voice discord-api-types  ytdl-core ytdl-core-discord ytsr ytpl ffmpeg-static prism-media abort-controller
```
